...
<html>
    ...
    <section>
        <form name="login" id="login" action="j_security_check" method="POST">
            <fieldset>
                ...
                <h1>Oviyam 2</h1> <h4>DICOM Web Workstation - Version 2.7</h4>
    ...
    <footer style="text-align: center;">OVIYAM 2.7 requires latest version of Google Chrome / Safari / Mozila Firefox.</footer>
</body>
</html>