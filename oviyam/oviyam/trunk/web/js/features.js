	...
	for(var x=0; x<rowIndex+1;x++) {	
		...
		for(var y=0;y<colIndex+1;y++) {
            ...
            if(cnt < seriesData.length) {
            	...
            	if(cnt<seriesData.length) {
            		divContent+='src="frameContent.html?series=' + data['seriesUID'] + '&seriesDesc=' +  data['seriesDesc'] + '&images=' +  data['totalInstances'] + '&modality=' + data['modality'] +'" style="background:#000; visibility: hidden;"></iframe></td>';
            	} else {
